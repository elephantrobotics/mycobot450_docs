...
After running successfully, all joints of the robot arm are in the released state.
...
**Note: Enter 2 to return the robot to its starting point before performing other coordinate control operations.**
...
```bash
roslaunch mycobot_pro_450_moveit demo.launch
```
...
```bash
# The default IP address of the Pro450 is "192.168.0.232" and the port number is 4500.
rosrun mycobot_pro_450_moveit sync_plan.py
```
...
[← Previous Page](./6.2.3-RVIZ_Introduction.md) | [Next section →](../6.3-ROS2/README.md)
