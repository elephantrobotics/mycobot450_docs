...
After successful execution, the terminal output information is as follows:
...
[follow_display-2] [INFO] [1757408024.905252117] [follow_display]: All servos released.
[follow_display-2] 
...
**Note: Enter 2 after the robot arm returns to its starting point before performing other coordinate control operations**
...
[← Previous Page](./6.3.3-RVIZ2_Introduction.md) | [Next section →](../6.4-Cplus/README.md)
