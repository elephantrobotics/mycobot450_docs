...
**Note:** After the system image is burned, each joint of the robotic arm needs to be **recalibrated at its zero position** before it can be used normally. Please refer to the section on [Zero-point calibration](https://docs.elephantrobotics.com/docs/mycobot-pro450-en/3-FunctionsAndApplications/5-BasicApplication/5.2-minirobot/5.2.5-calibration.html).
