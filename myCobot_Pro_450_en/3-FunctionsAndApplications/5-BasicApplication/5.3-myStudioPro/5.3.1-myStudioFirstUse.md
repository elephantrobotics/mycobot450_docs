...
![](../../../resources/3-FunctionsAndApplications/5-BasicApplication/5.3-myStudioPro/preparations/myblocklyInterface.jpg)

**myStudio Pro** is a one-stop robot programming and control software that supports visual programming interaction, quick movement control, drag-and-drop teaching, and robot status query and configuration. MyStudio Pro includes the `myBlockly` module.

**myBlockly** is similar in function and design to Scratch, the children's programming language from MIT.

When using **myBlockly**, users can build code logic by dragging and dropping modules. This process is like building with blocks.

From the user's perspective, **myBlockly** is a simple and easy-to-use visual code generation tool. From the developer's perspective, **myBlockly** is a text box containing the code entered by the user.

The process of generating code in the text box is the process of the user dragging and dropping code in myBlockly within **myStudio Pro**.
...
<img src="../../../resources/3-FunctionsAndApplications/5-BasicApplication/5.3-myStudioPro/preparations/link.png" />
...
<img src="../../../resources/3-FunctionsAndApplications/5-BasicApplication/5.3-myStudioPro/preparations/control.png" />
...
<img src="../../../resources/3-FunctionsAndApplications/5-BasicApplication/5.3-myStudioPro/preparations/internet.png" />
...
<img src="../../../resources/3-FunctionsAndApplications/5-BasicApplication/5.3-myStudioPro/preparations/internet1.png" />
...
<img src="../../../resources/3-FunctionsAndApplications/5-BasicApplication/5.3-myStudioPro/preparations/internet2.png" />
...
<img src="../../../resources/3-FunctionsAndApplications/5-BasicApplication/5.3-myStudioPro/preparations/ping.png" />
...
<img src="../../../resources/3-FunctionsAndApplications/5-BasicApplication/5.3-myStudioPro/preparations/session.png" />
...
<img src="../../../resources/3-FunctionsAndApplications/5-BasicApplication/5.3-myStudioPro/preparations/session2.png" />
...
<img src="../../../resources/3-FunctionsAndApplications/5-BasicApplication/5.3-myStudioPro/preparations/mycobotpro.png" />
...
<img src="../../../resources/3-FunctionsAndApplications/5-BasicApplication/5.3-myStudioPro/preparations/cmd.png" />
...
```
<img src="../../../resources/3-FunctionsAndApplications/5-BasicApplication/5.3-myStudioPro/preparations/ifconfig.png" />
...
<img src="../../../resources/3-FunctionsAndApplications/5-BasicApplication/5.3-myStudioPro/preparations/mystudio.png" />
