...
A: Please check the Pro force control gripper control method. The myCobotPro 450 gripper requires the `modbus` control method. Please configure the Pro force control gripper correctly and try again.
