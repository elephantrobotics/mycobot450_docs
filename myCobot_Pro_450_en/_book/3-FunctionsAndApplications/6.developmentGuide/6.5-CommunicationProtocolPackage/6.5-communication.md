...
`[Frame Header][Frame Header][Length][Function Code][Data][Checksum - High Byte][Checksum - High Byte]`<br> 
...
* Read the current direction first, then set it<br>
