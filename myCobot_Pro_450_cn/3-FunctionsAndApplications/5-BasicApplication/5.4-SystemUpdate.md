...
>> **注意：** 系统镜像烧录完成之后，机械臂各关节需要**重新校准零位**才能正常使用，请查看 [零位校准](https://docs.elephantrobotics.com/docs/mycobot-pro450-cn/3-FunctionsAndApplications/5-BasicApplication/5.2-minirobot/5.2.5-calibration.html) 章节内容。
