...
![usb](../../resources/5-BasicApplication/5.9-system_flash/double_usb.png)

- 双头USB线一端连接电脑，另一端连接Pro450机器底座的`USB1`接口（上面的USB口）

![usb](../../resources/5-BasicApplication/5.9-system_flash/robot_usb.png)
...
![usb](../../resources/5-BasicApplication/5.9-system_flash/5.9-1.png)
...
![usb](../../resources/5-BasicApplication/5.9-system_flash/5.9-2.png)

## 8 启动烧录工具

在**步骤7**启动系统烧录功能之后，打开烧录工具将会看到如下图：

![usb](../../resources/5-BasicApplication/5.9-system_flash/5.9-3.png)

- 点击 `升级固件`按钮

  ![usb](../../resources/5-BasicApplication/5.9-system_flash/5.9-4.png)

- 点击 `固件`按钮，打开文件资源管理器，选择烧录的系统镜像文件，然后点击 `打开`。

  ![usb](../../resources/5-BasicApplication/5.9-system_flash/5.9-5.png)

  ![usb](../../resources/5-BasicApplication/5.9-system_flash/5.9-6.png)

- 选择镜像文件之后，点击 `升级`按钮。

  ![usb](../../resources/5-BasicApplication/5.9-system_flash/5.9-7.png)

- 系统镜像烧录完成之后，烧录工具右侧将有提示信息：

  ![usb](../../resources/5-BasicApplication/5.9-system_flash/5.9-8.png)
...
![usb](../../resources/5-BasicApplication/5.9-system_flash/5.9-9.png)
