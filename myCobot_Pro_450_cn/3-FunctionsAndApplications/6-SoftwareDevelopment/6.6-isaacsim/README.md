...
[mycobot450_isaacsim](https://github.com/elephantrobotics/mycobot450_isaacsim) 是一个面向 **myCobot Pro 450** 的仿真与真实机器人协同控制仓库，基于：
...
- **软件与环境**  
  ...
  - 已安装 `pymycobot` 库（版本需大于`4.0.1`，通过 `pip install pymycobot` 终端命令安装）  
...
![isaacsim img1](../../../resources/3-FunctionsAndApplications/6.developmentGuide/isaacsim/images/isaacsim_start_1.png)
